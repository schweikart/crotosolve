...
yield its probability amplitudes and instead turns the state into either
...
} many times, I can estimate $\left|\alpha_n\right|^2$ as the relative frequency from the
empirical probability distribution of $M$.
% GLOBAL PHASE
% BLOCH SPHERE
