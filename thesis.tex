...
\graphicspath{{examplefiles/}}% this command from the graphics package allows to add folders (here subfolder "examplefiles") to be searched for graphic/image files
 ...
 \project{Advisors: Dr. Eileen Kühn, Dr. Max Fischer and Prof. Dr. Achim Streit}
 \addinfo{Steinbuch Centre for Computing}
...
\include{sections/03-bibliography}
\include{sections/04-schedule}
